...
class Tipoalimento
{
     ...
     *
     * @ORM\OneToMany(targetEntity="Gopro\FitBundle\Entity\Alimento", mappedBy="tipoalimento")
     */
    private $alimentos;
     ...
     * @param \Gopro\FitBundle\Entity\Alimento $alimento
     */
    public function removeAlimento(\Gopro\FitBundle\Entity\Alimento $alimento)
    {
